...
export function ChatWidget() {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    { role: "assistant", content: "Olá, aventureiro! 🌍 Sou seu guia de viagens. Me conte: que tipo de destino você procura?" },
  ]);
        ...
        {open && (
          ...
          >
            ...
            <div className="flex items-center justify-between p-3 border-b bg-primary text-primary-foreground rounded-t-2xl">
              <span className="font-display font-semibold text-sm">🧭 Guia de Viagens</span>
